...
EXPECTED_VALIDATOR_SHA256 = "d25412eec6acd9bddcf7ed69e2f0af3e365f877b326f26a7e473717b3fa1d915"
NUMBER = r"-?\d+(?:\.\d+)?(?:[dDfF])?"
...
SETTLED_VERIFIER_NORMALIZATIONS = (
    SettledVerifierNormalization(
        "pneumaticcraft",
        "91a4f84bce2d76e0204daeb05ad7d720b3fd548f",
...
CUMULATIVE_SCORE_RESET_RULES = (
    ...
    CumulativeScoreResetRule(
        "factory-blocks",
        "ad9ee2bcf0e2886ee88931f1eaf50ccb4b8a03bd",
    ...
    CumulativeScoreResetRule(
        "rftools-builder",
        "64471638ed4f61c102bd5f54986fba1cd467d6dd",
    ...
    CumulativeScoreResetRule(
        "modular-routers",
        "7fd7a4d0c40bd2dae13bb87e48445eb905322993",
        "data/modularrouters_gallery/function/build.mcfunction",
        (("#builds", "mr_gallery"),),
    ),
    CumulativeScoreResetRule(
        "securitycraft",
        "a99e816581b62c71dae3975e1e677a1ff93aec64",
        "data/securitycraft_gallery/function/build.mcfunction",
        (("#builds", "sc_gallery"),),
    ),
    CumulativeScoreResetRule(
        "functional-storage",
        "d085e3a4450dd2e8b1dc6d54541054ee36b4646c",
